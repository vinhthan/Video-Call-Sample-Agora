...
public class VideoChatViewActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == PERMISSION_REQ_ID) {
            ...
            Log.d("123123", "permission success");
        }
    }
    ...
    private void joinChannel() {
        ...
        mRtcEngine.joinChannel(token, "demoChannel1111", "Extra Optional Data", 0);
    }
...
/*    private void checkPermission() {
        PermissionListener permissionlistener = new PermissionListener() {
            ...
            public void onPermissionGranted() {
                initEngineAndJoinChannel();
                Toast.makeText(VideoChatViewActivity.this, "Permission Granted", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onPermissionDenied(List<String> deniedPermissions) {
                Toast.makeText(VideoChatViewActivity.this, "Permission Denied\n" + deniedPermissions.toString(), Toast.LENGTH_SHORT).show();
            }
        };
